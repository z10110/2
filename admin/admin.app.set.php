...
<div class="card">
    ...
    <div class="card-body mdui-p-a-0">
        <div id="Se1" class="mdui-p-a-2 layui-form">
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal">站点积分兑换总开关</label>
                <select class="custom-select mt-3" lay-search name="IntegratingSwitch">
                    <option <?= $conf['IntegratingSwitch'] == 1 ? 'selected' : '' ?> value="1">开启积分兑换商品功能
                    </option>
                    <option <?= $conf['IntegratingSwitch'] == 2 ? 'selected' : '' ?> value="2">关闭积分兑换商品功能
                    </option>
                </select>
                <div class="mdui-m-t-1">
                    <font color="red">关闭后，整站商品将无法使用积分兑换商品！</font>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal"
                       style="font-weight: 500">客服JS代码或IP统计代码,音乐播放器JS代码，都可以放到里面</label>
                <textarea name="statistics" rows="6"
                          class="form-control"><?= $conf['statistics'] ?></textarea>
                <div class="mdui-m-t-1">
                    <font color="red">如果输入的是JS代码，需要输入script标签,否则JS代码无法运行！</font>
                </div>
            </div>
            <div class="form-group mb-3">
                <label for="example-input-normal"
                       style="font-weight: 500">后台主页快捷跳转配置</label>
                <textarea name="BackgroundJump" rows="6"
                          class="form-control"><?= $conf['BackgroundJump'] ?></textarea>
                <div class="mdui-m-t-1">
                    <font color="red">格式：名称-跳转地址,名称-跳转地址 以此类推</font>
                </div>
            </div>

            <div class="form-group mb-3">
                <label for="example-input-normal">网站全局备案号[留空隐藏]</label>
                <input type="text" name="RecordNumber" class="form-control"
                       value="<?= $conf['RecordNumber'] ?>" placeholder="请输入网站全局备案号">
            </div>

            <div class="form-group mb-3">
                <label for="example-input-normal">用户协议[留空隐藏]</label>
                <input type="text" name="UserAgreement" class="form-control"
                       value="<?= $conf['UserAgreement'] ?>" placeholder="请填写链接地址,留空隐藏">
            </div>

            <div class="form-group mb-3">
                <label for="example-input-normal">隐私政策[留空隐藏]</label>
                <input type="text" name="PrivacyPolicy" class="form-control"
                       value="<?= $conf['PrivacyPolicy'] ?>" placeholder="请填写链接地址,留空隐藏">
            </div>

            <div class="form-group mb-3">
                <label for="example-input-normal">法律声明[留空隐藏]</label>
                <input type="text" name="LegalNotice" class="form-control"
                       value="<?= $conf['LegalNotice'] ?>" placeholder="请填写链接地址,留空隐藏">
            </div>

            <div class="form-group mb-3">
                <label for="example-input-normal" style="font-weight: 500">用户后台小提示内容,使用符号「-」分隔</label>
                <textarea name="UserBackgroundTips" rows="6"
                          class="form-control"><?= $conf['UserBackgroundTips'] ?></textarea>
            </div>
        ...
        <div id="Se2" class="mdui-p-a-2 layui-form">
            <fieldset class="layui-elem-field">
                <div class="layui-field-box">
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="color: #0a6ebd">通用自定义客服界面展示方式</label>
                        <select class="custom-select mt-3" lay-search name="ServiceUrlType">
                            <option <?= $conf['ServiceUrlType'] == 1 ? 'selected' : '' ?> value="1"
                            >采用内置页面显示模式【<?= htmlspecialchars("<iframe>") ?>】
                            </option>
                            <option <?= $conf['ServiceUrlType'] == 2 ? 'selected' : '' ?> value="2"
                            >采用打开新页面跳转模式【<?= htmlspecialchars('<a target="_blank">') ?>】
                            </option>
                            <option <?= $conf['ServiceUrlType'] == 3 ? 'selected' : '' ?> value="3"
                            >采用当前页面跳转模式【<?= htmlspecialchars('<a target="_self">') ?>】
                            </option>
                        </select>
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal"
                               style="color: #0a6ebd">通用自定义客服页面链接[留空不生效]</label>
                        <input type="text" name="ServiceUrl" class="form-control"
                               value="<?= $conf['ServiceUrl'] ?>" placeholder="请输入客服自定义页面链接">
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="color: #25c277">微信自定义客服界面展示方式</label>
                        <select class="custom-select mt-3" lay-search name="ServiceWxUrlType">
                            <option <?= $conf['ServiceWxUrlType'] == 1 ? 'selected' : '' ?> value="1"
                            >采用内置页面显示模式【<?= htmlspecialchars("<iframe>") ?>】
                            </option>
                            <option <?= $conf['ServiceWxUrlType'] == 2 ? 'selected' : '' ?> value="2"
                            >采用打开新页面跳转模式【<?= htmlspecialchars('<a target="_blank">') ?>】
                            </option>
                            <option <?= $conf['ServiceWxUrlType'] == 3 ? 'selected' : '' ?> value="3"
                            >采用当前页面跳转模式【<?= htmlspecialchars('<a target="_self">') ?>】
                            </option>
                        </select>
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal"
                               style="color: #25c277">微信自定义客服页面链接[留空默认调用通用链接配置]</label>
                        <input type="text" name="ServiceWxUrl" class="form-control"
                               value="<?= $conf['ServiceWxUrl'] ?>" placeholder="请输入微信客服自定义页面链接">
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="color: #ff683a">QQ自定义客服界面展示方式</label>
                        <select class="custom-select mt-3" lay-search name="ServiceQQUrlType">
                            <option <?= $conf['ServiceQQUrlType'] == 1 ? 'selected' : '' ?> value="1"
                            >采用内置页面显示模式【<?= htmlspecialchars("<iframe>") ?>】
                            </option>
                            <option <?= $conf['ServiceQQUrlType'] == 2 ? 'selected' : '' ?> value="2"
                            >采用打开新页面跳转模式【<?= htmlspecialchars('<a target="_blank">') ?>】
                            </option>
                            <option <?= $conf['ServiceQQUrlType'] == 3 ? 'selected' : '' ?> value="3"
                            >采用当前页面跳转模式【<?= htmlspecialchars('<a target="_self">') ?>】
                            </option>
                        </select>
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal"
                               style="color: #ff683a">QQ自定义客服页面链接[留空默认调用通用链接配置]</label>
                        <input type="text" name="ServiceQQUrl" class="form-control"
                               value="<?= $conf['ServiceQQUrl'] ?>" placeholder="请输入QQ客服自定义页面链接">
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="color: #695ff8">PC端自定义客服界面展示方式</label>
                        <select class="custom-select mt-3" lay-search name="ServicePCUrlType">
                            <option <?= $conf['ServicePCUrlType'] == 1 ? 'selected' : '' ?> value="1"
                            >采用内置页面显示模式【<?= htmlspecialchars("<iframe>") ?>】
                            </option>
                            <option <?= $conf['ServicePCUrlType'] == 2 ? 'selected' : '' ?> value="2"
                            >采用打开新页面跳转模式【<?= htmlspecialchars('<a target="_blank">') ?>】
                            </option>
                            <option <?= $conf['ServicePCUrlType'] == 3 ? 'selected' : '' ?> value="3"
                            >采用当前页面跳转模式【<?= htmlspecialchars('<a target="_self">') ?>】
                            </option>
                        </select>
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal"
                               style="color: #695ff8">PC端自定义客服页面链接[留空默认调用通用链接配置]</label>
                        <input type="text" name="ServicePCUrl" class="form-control"
                               value="<?= $conf['ServicePCUrl'] ?>" placeholder="请输入PC端客服自定义页面链接">
                    </div>
                    <blockquote style="color: red" class="layui-elem-quote">
                        此模块配置后，客服界面将跳转或显示客服自定义页面链接，由于此进阶配置只对部分模板生效，所以还是建议将下方配置全部填写！
                    </blockquote>
                </div>
            </fieldset>

            <div class="form-group mb-3">
                <label for="example-input-normal">微信客服二维码，留空不显示</label>
                <div class="input-group">
                    <input type="text" class="form-control" name="ServiceImage" id="image2"
                           value="<?= $conf['ServiceImage'] ?>" placeholder="微信客服二维码"/>
                    <div class="input-group-append">
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal">QQ客服二维码，留空不显示</label>
                <div class="input-group">
                    <input type="text" class="form-control" name="ServiceImageQQ" id="image3"
                           value="<?= $conf['ServiceImageQQ'] ?>" placeholder="QQ客服二维码"/>
                    <div class="input-group-append">
                        <span class="input-group-text" id="upload3" style="cursor: pointer">上传</span>
                    </div>
                    <div class="input-group-append">
                        <span class="input-group-text"
                              onclick="layer.alert('<img src=\''+$('#image3').val()+'\' style=width:100%  />')"
                              style="cursor: pointer;background-color: slateblue;color: white">预览</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal">客服微信，留空不显示</label>
                <input type="text" name="kfwx" class="form-control" value="<?= $conf['kfwx'] ?>"
                       placeholder="客服微信，留空不显示">
            </div>
        ...
        <div id="Se6" class="mdui-p-a-2 layui-form">
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal">用户等级价格列表展示</label>
            ...
            <div class="form-group mb-3">
                <label
                        for="example-input-normal">前台商品,分类,文章每页数据数,默认12，建议不要低于12,否则可能会出现异常</label>
            ...
            <div class="form-group mb-3" style="">
                ...
                <textarea class="form-control" name="navigation" rows="6"
        ...
        <div id="Se3" class="mdui-p-a-2 layui-form">
            <div class="form-group mb-3">
                <label for="example-input-normal">免费商品或积分商品每日兑换限制<font
                            color="red">(单一用户)</font></label>
                <input type="text" name="getinreturn" lay-verify="required" class="form-control"
                       value="<?= $conf['getinreturn'] ?>"
                       placeholder="每日单一用户可用积分兑换商品的次数(包含免费商品)">
            </div>

            <div class="form-group mb-3">
                <label for="example-input-normal">免费商品或积分商品每日兑换限制<font
                            color="red">(整个站点)</font></label>
                <input type="text" name="getinreturn_all" lay-verify="required" class="form-control"
                       value="<?= $conf['getinreturn_all'] ?>"
                       placeholder="每日整个站点可用积分兑换商品的次数(包含免费商品)">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal">订单延迟对接模式</label>
                <select class="custom-select mt-3" name="DelayedDocking">
                    <option <?= $conf['DelayedDocking'] == 1 ? 'selected' : '' ?> value="1">开启延迟发货
                    </option>
                    <option <?= $conf['DelayedDocking'] == 2 ? 'selected' : '' ?> value="2">关闭延迟发货
                    </option>
                </select>
                <div class="mdui-m-t-1">
                    开启后，会加快商品购买完成后的请求返回速度，下单不会卡顿，如果发现开启后无法正常自动发货，请关闭此功能！
                </div>
            </div>

            <div class="form-group mb-3">
                <label for="example-input-normal">对接弱验证模式</label>
                <select class="custom-select mt-3" name="DockingWeakVerification">
                    <option <?= $conf['DockingWeakVerification'] == 1 ? 'selected' : '' ?> value="1">开启
                    </option>
                    <option <?= $conf['DockingWeakVerification'] == 2 ? 'selected' : '' ?> value="2">关闭
                    </option>
                </select>
                <div class="mdui-m-t-1">
                    开启后，其他站点使用接口对接你时，会使用弱验证模式，关闭数据验证，增加对接成功率！
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal">订单提成发放模式</label>
                <select class="custom-select mt-3" name="RoyaltyDistributionMode">
                    <option <?= $conf['RoyaltyDistributionMode'] == 1 ? 'selected' : '' ?> value="1">即时发放,订单完成后就发放
                    </option>
                    <option <?= $conf['RoyaltyDistributionMode'] == 2 ? 'selected' : '' ?> value="2">延时发放,用户确认收货后才发放
                    </option>
                </select>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="OrderAstrict" lay-verify="required" class="form-control"
                       value="<?= $conf['OrderAstrict'] ?>"
                       placeholder="同信息商品下单间隔秒数(商品ID,下单信息,下单份数相同的订单)">
                <div class="mdui-m-t-1">
            ...
            <div class="form-group mb-3">
                ...
                <div class="mdui-m-t-1">
                    <font
                            color="red">包括但不限于,货源对接失败,自营商品下单,卡密商品发卡成功,api商品对接成功等所有成功状态！ </font>
                </div>
            </div>
        ...
        <div id="Se4" class="mdui-p-a-2 layui-form">
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal">目录保护,开启后可使用账号密码登录</label>
                <input type="text" name="Protect" class="form-control" value="<?= $conf['Protect'] ?>"
                       placeholder="目录保护后缀，留空不保护！">
                <div class="mdui-m-t-1">
                    <font color="red">设置后，登录站长后台需填写目录保护密码，请牢记！</font>
                </div>
            </div>
            <div class="form-group mb-3">
                ...
                <div class="mdui-m-t-1">
                    <font color="red">用于替换规避词内容，默认为 *
                        ，此功能默认开启，用于减少域名被墙的概率，规避字段由服务端统一配置！</font>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="mdui-m-t-1">
                    <font color="red">设置后，打开网站首页需要输入密码才可访问，不影响用户后台登录！</font>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select class="custom-select mt-3" name="CaptchaType" lay-filter="CaptchaType">
                    ...
                    <option <?= $conf['CaptchaType'] == 7 ? 'selected' : '' ?> value="7">启用云端验证码(本地验证码异常时使用)
                    </option>
                    <option <?= $conf['CaptchaType'] == 8 ? 'selected' : '' ?> value="8">极验行为验证V4(推荐)
                    </option>
                </select>
            </div>

            <div style="display: <?= $conf['CaptchaType'] == 8 ? 'block' : 'none'; ?>" id="GtCaptchaId"
                 class="form-group mb-3">
                <label for="example-input-normal">极验验证ID(V4)</label>
                <input type="text" name="GtCaptchaId" class="form-control"
                       value="<?= $conf['GtCaptchaId'] ?>"
                       placeholder="请填写完整！">
                <div class="mdui-m-t-1">
                    <font color="red">获取地址(登录<a href="https://www.geetest.com/" target="_blank">官网</a>后点击)：<a
                                href="https://console.geetest.com/sensbot/management"
                                target="_blank">https://console.geetest.com/sensbot/management</a></font>
                </div>
            </div>

            <div style="display: <?= $conf['CaptchaType'] == 8 ? 'block' : 'none'; ?>" id="GtCaptchaKey"
                 class="form-group mb-3">
                <label for="example-input-normal">极验验证KEY(V4)</label>
                <input type="text" name="GtCaptchaKey" class="form-control"
                       value="<?= $conf['GtCaptchaKey'] ?>"
                       placeholder="请填写完整！">
                <div class="mdui-m-t-1">
                    <font color="red">打开极验官网登录后，点击：行为验证->业务管理->创建业务模块->地址填写你站点地址，其他随意！</font>
                </div>
            </div>

            <div class="form-group mb-3">
                <label for="example-input-normal">验证码无效化开关</label>
                <select class="custom-select mt-3" name="VerificationCodeSwitch">
                    <option <?= $conf['VerificationCodeSwitch'] == 1 ? 'selected' : '' ?> value="1">启用验证码正常验证模式
                    </option>
                    <option <?= $conf['VerificationCodeSwitch'] == 2 ? 'selected' : '' ?> value="2">启用验证码无效化验证模式
                    </option>
                </select>
                <div class="mdui-m-t-1">
                    <font color="red">启用无效化模式后,验证码就是一个摆设,无论输入什么,都是验证通过</font>
                </div>
            </div>
            <div class="form-group mb-3">
        ...
        <div id="Se5" class="mdui-p-a-2 layui-form">
            <div class="form-group mb-3">
                ...
                <div class="mdui-m-t-1">
                    <font
                            color="red">0.1=压缩到10%,1=不压缩，如果图片为透明背景，则会变为黑色！,此功能除了用于减少图片大小，还可用于防止图片木马等一系列上传文件相关漏洞！</font>
                </div>
            </div>
            <div class="form-group mb-3">
                <label for="example-input-normal">API对接密钥[切勿泄露,可以用来操作站点后台任何内容]</label>
                <input type="text" name="secret" lay-verify="required" class="form-control"
                       value="<?= $conf['secret'] ?>" placeholder="调用后台接口时使用！">
            </div>
            <div class="form-group mb-3">
                <label for="example-input-normal">API监控密钥,用于监控网站功能</label>
                <input type="text" name="monitor_key" lay-verify="required" class="form-control"
                       value="<?= $conf['monitor_key'] ?>" placeholder="监控网站功能时使用！">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal">全局应用槽位 <a href="javascript:"
                                                                  onclick="layer.alert('开启后，可以使用调用了全局钩子的应用，具体参考对应应用说明，来决定是否开启！')">说明</a></label>
                <select class="custom-select mt-3" lay-search name="AppGlobals">
                    <option <?= $conf['AppGlobals'] == -1 ? 'selected' : '' ?> value="-1">关闭全局应用钩子
                    </option>
                    <option <?= $conf['AppGlobals'] == 1 ? 'selected' : '' ?> value="1">开启全局应用钩子
                    </option>
                </select>
            </div>

            <div class="form-group mb-3" style="">
                <label for="example-input-normal" style="position: relative;bottom: 0;left: 0">购物车收银台公告
                    (纯文字即可)</label>
            ...
            <div class="form-group mb-3" style="">
                <label for="example-input-normal"
                       style="position: relative;bottom: 0;left: 0">强制同步调用钩子列表（多个钩子使用|分隔） <a
                            href="https://docs.apipost.cn/preview/19a59be27210150f/c9856a615ee905a9?target_id=67d3cc41-96c0-400e-80cd-70c0eecc59f8"
                            target="_blank">文档</a></label>
                <textarea class="form-control" name="SynchroHookList" id="SynchroHookList" rows="6"
                          placeholder="请输入需要同步执行的钩子"><?= $conf['SynchroHookList'] ?></textarea>
            </div>
...
<script>
    layui.use('form', function () {
        ...
        //监听CaptchaType
        form.on('select(CaptchaType)', function (data) {
            if (data.value == 8) {
                $("#GtCaptchaId").show();
                $("#GtCaptchaKey").show();
            } else {
