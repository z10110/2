    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                商品列表（根据sort值降序显示前100个）
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-muted font-14">当前商品总数：{{ count
                            }}个(包含已下架商品),排序ID越高,商品越靠前</p>
                        <div class="button-list">
                            ...
                            <button type="button" onclick="operation.execute(this.innerHTML,6)"
                                    class="btn btn-outline-danger btn-rounded">将所有商品排序ID设置为0
                            </button>
                        </div>
                    </div>
                </div>
