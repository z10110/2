...
<div class="card" id="App">
                        ...
                        <div class="mdui-grid-tile-actions">
                            <div class="mdui-grid-tile-text">
                                ...
                                <div class="mdui-grid-tile-subtitle">
                                    <span mdui-tooltip="{content: '商品数量', position: 'top'}"
                                          class="badge badge-primary">{{item.count}}个</span>
                    ...
                    >
                        <div class="mdui-grid-tile">
                            ...
                            <div class="mdui-grid-tile-actions mdui-grid-tile-actions-top">
                                <div class="mdui-grid-tile-text">
                                    <div class="mdui-grid-tile-title">{{item.name}}</div>
                                    <span class="badge badge-warning mdui-m-l-1">
                                        {{item.annotation}}
                                    </span>
                                </div>
                            </div>
        ...
        <div id="tab3" class="mdui-p-a-0 mdui-m-t-2">
            ...
            <div v-show="MyIslandList.length>0">
                <div class="mdui-textfield">
                    ...
                    <input class="mdui-textfield-input" v-model="MyIslandSearch" placeholder="请输入商城关键词"
                           type="text"/>
                    <div class="mdui-textfield-helper" style="height:auto;">
            ...
            <fieldset class="layui-elem-field">
                ...
                <div class="layui-field-box">
                    ...
                    <div class="mdui-textfield">
                        ...
                        <input v-model="MyIslandData.data.name" placeholder="请输入站点名称"
    ...
    <div class="mdui-text-center mdui-m-b-2">商品图存本地：<span
                v-if="LocalizedState==1" style="color: seagreen;cursor: pointer" @click="LocalizedState=2">开启中</span><span
                style="color: red;cursor: pointer" @click="LocalizedState=1" v-else>已关闭</span><br><span
                style="color: #666;font-size: 8px;">(点状态切换,开启后上架会变慢)</span>
    </div>
</div>
