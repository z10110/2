    ...
    <div class="col-sm-8">
        <div class="card">
            <div class="card-header">
                API监控密钥可前往：网站配置->其他杂项 <a href="admin.app.set.php">修改</a>
            </div>
            <div class="card-body">
                <div class="mdui-textfield">
                    ...
                    <input class="mdui-textfield-input"
                           ...
                           value="<?= href(2) . ROOT_DIR_S ?>/api.php?act=Supervisory&token=<?= $conf['monitor_key'] ?>&num=10"
                           type="text"/>
                    <div class="mdui-textfield">
                ...
                <div class="mdui-textfield">
                    ...
                    <input class="mdui-textfield-input"
                           onclick="copyToClip(this.value)"
                           value="<?= href(2) . ROOT_DIR_S ?>/api.php?act=OrderStatusMonitoring&token=<?= $conf['monitor_key'] ?>&num=10"
                           type="text"/>
                    <div class="mdui-textfield">
                        监控频率：1分钟1次 <a href="admin.order.list.php"
                                      target="_blank">管理</a><br>
                        监控范围：3天内的串货类订单，对接成功的订单，非退款，非完成状态的订单<br>
                        监控效果：实时将对接订单的状态和本地同步<br>
                        注意事项：为防止出错，退款订单无法同步改状态，仅单独标记出来，需手动操作处理！,可以通过调整num参数来控制单次的监控数量，1-60条
                    </div>
                </div>
                ...
                <div class="mdui-textfield">
                    ...
                    <input class="mdui-textfield-input"
                           onclick="copyToClip(this.value)"
                           value="<?= href(2) . ROOT_DIR_S ?>/api.php?act=HostMonitoring&token=<?= $conf['monitor_key'] ?>"
                           type="text"/>
                    <div class="mdui-textfield">
                ...
                <div class="mdui-textfield">
                    ...
                    <input class="mdui-textfield-input"
                           onclick="copyToClip(this.value)"
                           value="<?= href(2) . ROOT_DIR_S ?>/api.php?act=HostSpaceMonitoring&token=<?= $conf['monitor_key'] ?>"
                           type="text"/>
                    <div class="mdui-textfield">
...
<!--                <div class="mdui-textfield">-->
                ...
                <!--                           onclick="copyToClip(this.value)"-->
                <!--                           value="-->
                <?php //= href(2) . ROOT_DIR_S ?><!--/api.php?act=OrdersTesting&token=-->
                <?php //= $conf['monitor_key'] ?><!--"-->
                <!--                           type="text"/>-->
                <!--                    <div class="mdui-textfield">-->
