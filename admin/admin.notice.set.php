                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal layui-form">
                            ...
                            <div class="form-group mb-3">
                                <label for="example-input-normal" style="font-weight: 500">用户注册页面公告</label>
                                <textarea id="TradeMarkPublication" class="form-control"
                                          style="display:none"></textarea>
                                <div id="contentHtml9"><?= ($conf['TradeMarkPublication'] === '' ? '' : '<div>' . $conf['TradeMarkPublication'] . '</div>') ?></div>
                                <span style="cursor:pointer;color: #0AAB89;font-size: 0.5em;"
                                      onclick="EmptyDocs('TradeMarkPublication');">清空全部内容</span>
                                <span style="cursor:pointer;color: red;font-size: 0.5em;"
                                      onclick="HtmlDocs('TradeMarkPublication');">编辑原始代码</span>
                            </div>


                            <div class="form-group mb-3">
                                <label for="example-input-normal" style="font-weight: 500">用户登录页面公告</label>
                                <textarea id="LoginAnnouncement" class="form-control"
                                          style="display:none"></textarea>
                                <div id="contentHtml10"><?= ($conf['LoginAnnouncement'] === '' ? '' : '<div>' . $conf['LoginAnnouncement'] . '</div>') ?></div>
                                <span style="cursor:pointer;color: #0AAB89;font-size: 0.5em;"
                                      onclick="EmptyDocs('LoginAnnouncement');">清空全部内容</span>
                                <span style="cursor:pointer;color: red;font-size: 0.5em;"
                                      onclick="HtmlDocs('LoginAnnouncement');">编辑原始代码</span>
                            </div>
                        ...
                        <span class="mt-3" style="display: block">若不懂代码,可点击：<span
