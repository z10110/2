...
<div class="card" id="App">
    ...
    <div class="card-body">
        <div class="layui-row layui-col-space8">
            <div v-for="(item,index) in Data" class="layui-col-xs12 layui-col-sm4 layui-col-lg3">
                <div class="card mdui-ripple" style="cursor:auto">
                    ...
                    <div class="card-body">
                        <div class="layui-row">
                            ...
                            <div class="layui-col-xs12 layui-col-sm8" style="font-size: 80%;">
                                ...
                                <div class="layui-elip w-100">已经对接: <a :href="'admin.goods.list.php?sqid='+item.id"
                                                                           target="_blank" title="点击查看商品">{{
                                        item.count }}个商品</a>
                                </div>
                            ...
                            <div class="layui-col-xs12 layui-col-sm12 mt-1" style="color: #ccc;"
                            ...
                            <div class="layui-col-xs12 layui-col-sm12 mt-1">
                                ...
                                <a class="btn btn-primary badge ml-1" target="_blank"
                                   :href="'admin.goods.list.php?sqid='+item.id">
                                    看
                                </a>
                                <a class="btn btn-warning badge ml-1" :href="'./admin.source.add.php?id='+item.id">
