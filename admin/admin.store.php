    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header mdui-p-a-1 mdui-shadow-1">
                <a title="清理数据缓存" href="javascript:App.initialization(-2,-1,2);"
                   class="badge badge-warning mdui-m-l-1"><i
                ...
                <a style="height: 22px;margin-top: -12px;line-height: 18px;"
                   ...
                   class="badge badge-danger mdui-text-color-white mdui-m-l-1">检查应用更新</a>
            ...
            <div class="card-body m-t-0" style="overflow-y: auto;">
                <div v-if="name!==''" class="mb-2">正在查看[ {{name}} ]的搜索结果 <a
                ...
                <table id="table" class="table table-hover table-centered mb-0"
                    ...
                    <tr v-for="(item,index) in Data">
                        ...
                        <td>
                            <span class="badge badge-info-lighten" style="cursor: pointer"
                                  @click="UserGrade(item)"
                                  title="商城用户等级高于此等级才可以看见这个插件，否则开启了对应导航菜单也无法看见此插件">商城用户 ≧ {{item.user_grade}}级</span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <div v-else>
                                <span v-if="item.MenuAdmin==1" @click="MenuSet(item.identification,'MenuAdmin',2)"
                                      style="cursor:pointer;margin-right: 0.2em;"
                                      class="badge badge-success-lighten">主站后台
                                </span>
                                <span v-else style="cursor:pointer;margin-right: 0.2em;"
                                      @click="MenuSet(item.identification,'MenuAdmin',1)"
                                      class="badge badge-danger-lighten">主站后台
                                </span>

                                <span v-if="item.MenuUser==1" style="cursor:pointer;margin-right: 0.2em;"
                                      @click="MenuSet(item.identification,'MenuUser',2)"
                                      class="badge badge-success-lighten">分站后台
                                </span>
                                <span v-else style="cursor:pointer;margin-right: 0.2em;"
                                      @click="MenuSet(item.identification,'MenuUser',1)"
                                      class="badge badge-danger-lighten">分站后台
                                </span>

                                <span v-if="item.MenuHome==1" style="cursor:pointer;margin-right: 0.2em;"
                                      @click="MenuSet(item.identification,'MenuHome',2)"
                                      class="badge badge-success-lighten">前台模板
                                </span>
                                <span v-else style="cursor:pointer;margin-right: 0.2em;"
                                      @click="MenuSet(item.identification,'MenuHome',1)"
                                      class="badge badge-danger-lighten">前台模板
                                </span>
                            </div>
                        </td>
                        <td>
