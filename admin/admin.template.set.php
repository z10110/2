            ...
            <div v-if="TemData!==false">
                <h3>
                    ...
                    <span class="badge badge-danger-lighten"
                          v-if="TemData.conf.UserBackgroundTemplatePC==-1">已关闭</span>
                ...
                <h3>
                    用户后台移动端模板：
                    <span class="badge badge-danger-lighten"
                          v-if="TemData.conf.UserBackgroundTemplateM==-1">已关闭</span>
        ...
        <pre class="layui-code">
{
    ...
    "extend": [  //输入框和选择框的配置区，不需要配置的话，直接返回[]
        ...
        <hr>
        首页模板配置获取接口：<span
                style="color: rgba(67,35,218,0.6)"><?= href(2) ?>/main.php?act=TemData&name=模板名称</span><br>
        用户后台模板配置获取接口：<span
                style="color: rgba(67,35,218,0.6)"><?= href(2) ?>/user/ajax.php?act=TemData&name=模板名称</span><br>
        极验行为验证集成方法请参考：<span
                style="color: rgba(67,35,218,0.6)">/assets/user/login/main.js</span>和<span
                style="color: rgba(67,35,218,0.6)">/template/default/login.php</span>文件
    </div>
</div>
