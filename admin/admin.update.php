...
<div class="card" id="App">
    ...
    <div v-else class="mdui-card">
        ...
        <div class="mdui-card-actions">
            ...
            <button v-else class="mdui-btn mdui-ripple" @click="CalibreProgramFile()">校准程序文件</button>
    ...
    const App = Vue.createApp({
        ...
        methods: {
            ...
            CalibreProgramFile() {
                mdui.dialog({
                    title: '程序文件校准',
                    content: '确认校准程序文件吗，此功能可以确保程序原生文件的完整性，防止被第三方插件修改后导致无法正常使用！<hr>为了防止出现异常，校准前可以先备份程序文件哦',
                    modal: true,
                    history: false,
                    buttons: [{
                        text: '关闭',
                    },
                        {
                            ...
                            onClick: function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: 'main.php?act=CalibreProgramFile',
                                    dataType: "json",
                                    success: function (res) {
                                        layer.close(is);
                                        if (res.code == 1) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (res) {
                                                    ...
                                                    if (res.code == 1) {
                                                        ...
                                                        App.CalibrationDatabaseSeamless();
                                                        App.Ajax(2);
                                                    } else {
                                                        mdui.dialog({
                                                            title: '抱歉',
