<?php
global $cdnserver, $accredit, $conf;
?>
...
<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                2020 - 2025 © All rights reserved - <?= $conf['sitename'] ?>
            </div>
            <div class="col-md-6">
                <div class="text-md-right footer-links d-none d-md-block">
                    <a href="https://cdn.79tian.com/api/wxapi/view/flock.php" class="group"
                       target="_blank">官方交流群</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="Hover" style="margin-bottom:50px;">
    <div title="便利服务" onclick="ConvenienceService()" class="HoverIcon mdui-ripple">
        <img src="../assets/img/cloude.png"
...
<div id="Hover" style="display: none">
    <div class="Hover" v-if="List.length>=1">
        <div class="HoverIcon mdui-ripple" title="展开" @click="switchs()">
            <img src="../assets/img/apps.png" style="width: 2.5rem;height: 2.5rem;padding: 2px;"/>
        </div>
