                            ...
                            <ul class="navbar-nav">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-project">
                                                ...
                                                <a href="./admin.goods.monitoring.php"
                                                   class="dropdown-item">商品监控</a>
                                                <a href="../?mod=UpAndDown" target="_blank"
                                                   class="dropdown-item">价格波动</a>

                                                <a href="./admin.goods.dockingSystem.php"
                                                   class="dropdown-item">一键串货</a>
                                            </div>
                                        </div>
                                        <a href="./admin.goods.supply.php" class="dropdown-item">供货大厅</a>
                                        <a href="./admin.PriceRule.php" class="dropdown-item">加价规则</a>
                                        <div class="dropdown">
                                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                               id="topnav-project" role="button" data-toggle="dropdown"
                                               aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-project">
                                                ...
                                                <a href="./admin.source.promotion.php"
                                                   class="dropdown-item">货源推广</a>
                                                <a href="https://docs.apipost.cn/preview/19a59be27210150f/c9856a615ee905a9?target_id=9c4094c6-6ea7-4d9f-8112-aba84cbc16c5"
                                                   target="_blank"
                                                   class="dropdown-item">直客API模拟</a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                        ...
                                        <a href="./admin.after.sale.php" class="dropdown-item">售后管理</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                                        ...
                                        <a href="./admin.shipping.address.php" class="dropdown-item">收货地址</a>
                                        <a href="./admin.return.address.php" class="dropdown-item">退货地址</a>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-project">
                                                <a href="./admin.increasePrice.list.php"
                                                   class="dropdown-item">规则列表</a>
                                                <a href="./admin.increasePrice.add.php"
                                                   class="dropdown-item">新增规则</a>
                                            </div>
                                        </div>
                                        <div class="dropdown">
                                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-project">
                                                <a href="./admin.goods.cash.add.php"
                                                   class="dropdown-item">添加商品兑换卡密</a>
                                                <a href="./admin.goods.cash.list.php"
                                                   class="dropdown-item">管理商品兑换卡</a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-layouts" id="Menu">
                                        <a href="./admin.store.php" class="dropdown-item">应用列表</a>
                                        <a href="./admin.charge.money.php" class="dropdown-item">余额充值</a>
                                        <a v-for="(item,index) in List"
                                           :href="'./AppView.php?id='+item.id + '&name='+item.name"
                                           class="dropdown-item"><img :src="item.image"
                                                                      style="width: 14px;border-radius: 32px;margin-right: 2px"
                                            />{{ item.name
                                            }}</a>
                                    </div>
                                </li>
