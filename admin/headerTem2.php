            ...
            <ul class="metismenu side-nav">
                    ...
                    <ul class="side-nav-second-level" aria-expanded="false">
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-third-level" aria-expanded="false">
                                ...
                                <li>
                                    <a href="https://cdn.79tian.com/api/wxapi/view/index.php"
                                       target="_blank">授权管理</a>
                                </li>
                                <li>
                ...
                <li class="side-nav-item">
                    ...
                    <ul class="side-nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="./admin.PriceRule.php">加价规则</a>
                        </li>
                        <li>
                ...
                <li class="side-nav-item">
                    ...
                    <ul class="side-nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="./admin.after.sale.php">售后管理</a>
                        </li>
                        <li>
                ...
                <li class="side-nav-item">
                    ...
                    <ul class="side-nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="./admin.shipping.address.php">收货地址</a>
                        </li>
                        <li>
                            <a href="./admin.return.address.php">退货地址</a>
                        </li>
                        <li>
                ...
                <li class="side-nav-item">
                    ...
                    <ul class="side-nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="./admin.login.set.php">快捷登录</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="./admin.backup.php">数据备份</a>
                        </li>
                        <li class="side-nav-item">
                ...
                <li id="Menu" class="side-nav-item">
                    <a href="admin.store.php" class="side-nav-link">
                        <i class="layui-icon layui-icon-component"></i>
                        <span> 应用商店 </span>
                    </a>
                    <a href="admin.charge.money.php" class="side-nav-link">
                        <i class="layui-icon layui-icon-component"></i>
                        <span> 余额充值 </span>
                    </a>
                    <a v-for="(item,index) in List" :href="'./AppView.php?id='+item.id + '&name='+item.name"
                       class="side-nav-link">
                        <img :src="item.image" style="width: 24px;border-radius: 32px;margin-right: 8px"
                        />
                        <span>{{ item.name }}</span>
                    </a>
                </li>
