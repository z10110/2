...
$Ms = time() - $_SESSION['ADMIN_PRODUCT_MS'];
if ($Ms >= 60) {
    unset($_SESSION['ADMIN_PRODUCT_MS']);
    $Ms = 0;
} else {
    $Ms = 60 - $Ms;
}
...
<head>
    ...
    <link rel="stylesheet" href="../assets/layui/css/layui.css" id="theme-stylesheet">
</head>
<body>
<style>
    .login-page::before {
    <?= (!$image ? 'background-image: linear-gradient(to right, #e0eafc, #cfdef3);' : $image) ?>
    }
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="width: 31%;display:inline-block">
                                            <button style="width: 100%;height: 34px;line-height: 22px;"
                                                    class="btn btn-warning"
                                                    id="DoLoginCode"
                                                    ms="<?= $Ms ?>"
                                                    tips="<?= $Ms ?>秒后可重发"
                                                    onclick="AdminLogin.do_admin_get_mobile_code()"><?= $Ms >= 1 ? $Ms . '秒' : '获取' ?>
                                            </button>
                                        </div>
                                    </div>
