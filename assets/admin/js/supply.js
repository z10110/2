const App = Vue.createApp({
    data() {
        return {
            ...
            //图片本地化
            LocalizedState: 2, //本地化状态,1开启，2关闭
        }
    }, methods: {
        SelectMyMoney(money) {
            App.MyMoney = money;
    ...
    ` + content + `
            ...
            for (const index in this.ClassData) {
                ...
                html += `<label class="mdui-list-item mdui-ripple">
                            ...
                            <label class="mdui-radio">
                                <input onclick="App.SelectCategories(` + item.cid + `)" type="radio" value="` + item.cid + `" name="cid"
...
` + html + `
            ...
            data.LocalizedState = App.LocalizedState;
            $.ajax({
                type: "POST",
