...
<body
        style="<?= !background::image() ? 'background:linear-gradient(to right, #bdc3c7, #2c3e50);' : background::image() ?>">
<div style="padding-top:6px;" id="app">
        ...
        <div class="block block-link-hover3" style="box-shadow:0px 5px 10px 0 rgba(0, 0, 0, 0.25);">
            ...
            <div class="block-content block-content-mini block-content-full">
                <div class="btn-group btn-group-justified">
                    ...
                    <?php if ($User) { ?>
                        <div class="btn-group">
                            <a class="btn btn-default" data-toggle="modal" href="?mod=route&p=User"><i
        ...
        <div class="block" style="box-shadow:0px 5px 10px 0 rgba(0, 0, 0, 0.25);">
            ...
            <div class="block-content tab-content">
                    ...
                    <div>
                        <div class="form-group" id="display_searchBar">
                            <div class="input-group">
                                ...
                                <input v-model="GoodsSeek" type="text" class="form-control"
                                       placeholder="请填写商品关键词">
                        ...
                        <div style="display: none;"
                            ...
                            <div class="form-group" style="color:#4169E1;font-weight:bold">
                                <div class="input-group">
                                    ...
                                    <input v-else-if="Goods.name != -1" type="text" class="form-control"
                                           :value="NumRound(Goods.price * num).toFixed(Goods.accuracy)"
                            ...
                            <div class="form-group" v-for="(item, index) of Goods.input" :key="index">
                                            ...
                                            <div style="margin-top:0.5em">
                                                <div style="display:inline-block;" v-for="(ts, is) in item" :key="is">
                                                    <button
                                                            ...
                                                            style="margin: 0.3em;border-radius: 0.5em;border: none;box-shadow:3px 3px 8px rgba(151,149,149,0.28);">
                                                        {{ is }}
                                                    </button>
                                                    <button
                                                            type="button"
                                ...
                                <div class="input-group" v-if="item.state == 7">
                                    <div class="input-group-addon">{{ item.Data[0] }}</div>
                                    <span class="input-group-btn">
											<input type="button" @click="AdjustmentMultiple(1)" class="btn btn-danger"
                                                   style="border-radius: 0;" value="━">
										</span>
                                    <input v-on:input="AdjustmentMultiple(0)" class="form-control"
                                           v-model.number="form[index]"
                                           :placeholder="'请填写需要购买的'+item.Data[0]"
                                           type="number" :min="1"/>
                                    <span class="input-group-btn">
											<input type="button" @click="AdjustmentMultiple(2)" class="btn btn-success"
                                                   style="border-radius: 0;" value="✚">
										</span>
                                </div>
                            </div>
                ...
                <div class="tab-pane <?= (!isset($_QET['query']) ? '' : 'active') ?>" id="search">
                    ...
                    <div class="alert alert-warning" <?= (!$User ? 'style="margin-top: 1em;"'
                        : 'style="display: none;margin-top: 1em;"') ?>>
                        <a href="#" class="close" data-dismiss="alert">
                            &times;
                        </a>
                        <a href="./?mod=route&p=User"
                           style="color: #efa231;"><strong>警告！</strong>检测到您未登录，登录后可绑定订单，他人无法查询，保护您的购买信息，点我登录！</a>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="block">
                                ...
                                <center style="color: #b2b2b2;"><small><em>* 自己的能力决定着你的收入！</em></small>
                                </center>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
        ...
        <div class="block block-content block-content-mini block-content-full"
            ...
            <div class="block-content text-center border-t">
                ...
                <?php if (!empty($conf['RecordNumber'])) { ?>
                    <p>
                        备案号:<a style="text-decoration:none" href="https://beian.miit.gov.cn/"
                                  target="_blank">
                            <?= $conf['RecordNumber'] ?>
                        </a>
                    </p>
    ...
    <script src="<?php echo $cdnserver; ?>assets/layui/layui.js"></script>
