...
<head>
    ...
    <script type="module" crossorigin src="./assets/template/PcStore/assets/index.166dacab.js"></script>
    <link rel="stylesheet" href="./assets/template/PcStore/assets/index.05963751.css">
...
<script nomodule id="vite-legacy-polyfill" src="./assets/template/PcStore/assets/polyfills-legacy.bea067ca.js"></script>
<script nomodule id="vite-legacy-entry"
        data-src="./assets/template/PcStore/assets/index-legacy.2982c1d3.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
