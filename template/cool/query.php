...
<!DOCTYPE html>
<html lang="zh"
      style="font-size: 102.4px;<?= !background::image() ? 'background:linear-gradient(to right, #bdc3c7, #2c3e50);' : background::image() ?>">
                                    ...
                                    <div class="text-left">
                                        <ul class="pagination">
                                            ...
                                            <li <?= ($User === false ? '' : 'style="display: none;"') ?>>
                                                <a style="color: red;margin-left:1em;" href="./?mod=route&p=User">检测到您未登录，登录后可绑定订单，他人无法查询，保护您的购买信息，点我登录！</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
