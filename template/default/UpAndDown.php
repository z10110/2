...
<div class="mdui-container-fluid mdui-m-t-1" style="overflow:hidden;width:100%;overflow-x: auto;overflow-y:auto;">
    ...
    <div style="width: 100%;text-align: center;margin-top: 1em;"><?= $conf['statistics'] ?></div>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.code === 1) {
                            ...
                            App.GetData = res;
                            if (App.Data.length === 0 && App.List.length >= 1 && App.name != App.List[0]) {
                                App.GetList(App.List[0]);
                            }
                        } else {
                            App.Data = [];
                            App.List = [];
